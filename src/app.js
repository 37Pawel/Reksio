...
const firebaseConfig = {
  ...
  databaseURL:
    "https://reksio-21bee-default-rtdb.europe-west1.firebasedatabase.app",
};
...
//   uploadBytes(myImgRef, file).then(() => (myStatus.innerText = "Przesłano!"));
// });
...
// //     });
// //   });
// const imageRef = ref(storage, "Halalala");
...
// const storageRed = ref(storage);
// listAll(storageRed).then((res) => {
...
// const albumDoc = doc(db, "albums/LzZyUg2y1OFD6FELuMHf");
...
// const stopperDoc = doc(db, "stopper", "stopper");
// onSnapshot(stopperDoc, (doc) => {
